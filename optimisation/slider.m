...
% Last Modified by GUIDE v2.5 22-Feb-2011 11:09:07
...
%jSB = findjobj(handles.slider1);
%jSB.AdjustmentValueChangedCallback = @draw_temp;

%hhSlider = handle(handles.slider1);
%hProp = findprop(hhSlider,'Value');  % a schema.prop object
%hListener = handle.listener(hhSlider,hProp,'PropertyPostSet',@draw_temp);

handles.hListener = iptui.iptaddlistener(handles.slider1,'ActionEvent',@draw_temp);
